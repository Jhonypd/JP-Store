-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('WAITTING_FOR_PAYMENT', 'PAYMENT_CONFINRMED');
...
CREATE TABLE "Order" (
    ...
    "status" "OrderStatus" NOT NULL DEFAULT 'WAITTING_FOR_PAYMENT',
...
-- AddForeignKey
ALTER TABLE "userAdm" ADD CONSTRAINT "userAdm_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
